...
showDeathsNew = (total) => {
  document.querySelector("#deaths-new").textContent = numberWithCommas(total);
};
    ...
    world_data.forEach(e =>{
        switch(status){
            ...
            case CASE_STATUS.deaths:
                ...
                break
            // case CASE_STATUS.newconfirmed:
            //     res.push(e.NewConfirmed)
            //     break
            // case CASE_STATUS.newrecovered:
            //     res.push(e.NewRecovered)
            //     break
            // case CASE_STATUS.newdeaths:
            //     res.push(e.NewDeaths)
            //     break
        }
    })
    return res
...
loadAllTimeChart = async(country) =>{
    ...
    if(isGlobal(country)){
        ...
        // newconfirm_data = renderWorldData(world_data, CASE_STATUS.newconfirmed)
        // newrecovered_data = renderWorldData(world_data, CASE_STATUS.newrecovered)
        // newdeaths_data = renderWorldData(world_data, CASE_STATUS.newdeaths)
        ...
        //  let newconfirmed = await covidApi.getCountryAllTimeCases(country,CASE_STATUS.newconfirmed) 
        //  let newrecovered = await covidApi.getCountryAllTimeCases(country, CASE_STATUS.newrecovered)   
        //  let newdeaths = await covidApi.getCountryAllTimeCases(country, CASE_STATUS.newdeaths)  

         confirm_data = renderData(confirmed) 
         recovered_data = renderData(recovered) 
         deaths_data = renderData(deaths) 
        //  newconfirm_data = renderData(newconfirmed) 
        //  newrecovered_data = renderData(newrecovered) 
        //  newdeaths_data = renderData(newdeaths) 
        ...
        //   {
        //     name: "NewConfirmed",
        //     data: newconfirm_data,
        //   },
        //   ,
        //   {
        //     name: "NewRecovered",
        //     data: newrecovered_data,
        //   },
        //   ,
        //   {
        //     name: "NewDeaths",
...
setDarkChart = (dark) =>{
  ...
  recover_time_chart.updateOptions(theme)
}
...
// country filter
// initCountryFilter = () =>{
//   let input = document.querySelector('#counter-select-list input')
//   input.onkeyup = () =>{
